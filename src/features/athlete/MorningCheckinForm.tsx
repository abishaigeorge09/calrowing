  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-50 flex flex-col justify-end">
      <div className="bg-black/95 border-t border-white/10 w-full rounded-t-[2.5rem] flex flex-col safe-bottom max-h-[92dvh] shadow-[0_-20px_50px_rgba(0,0,0,0.8)] relative">
        ...
        {/* Header */}
        <div className="flex items-center justify-between mb-6 relative z-10 px-6 pt-8">
          <div>
            <p className="text-[10px] uppercase font-black tracking-widest text-gray-500 mb-1">Morning Check-in</p>
        ...
        <div className="relative z-10 w-full max-w-sm mx-auto min-h-[40vh] flex flex-col pt-4">
          {step === 0 && (
            <div className="space-y-8 flex-1 pb-4">
              <div className="space-y-4">
                <Label className="text-[10px] uppercase font-black tracking-widest text-gray-400">Sleep Duration (Hours)</Label>
              ...
              <div className="space-y-4 pt-4 border-t border-white/5">
                <Label className="text-[10px] uppercase font-black tracking-widest text-gray-400">Sleep Quality</Label>
          ...
          {step === 1 && (
            <div className="space-y-8 flex-1 pb-4">
              <div className="space-y-3">
                <Label className="text-[10px] uppercase font-black tracking-widest text-gray-400">Energy Level</Label>
              ...
              <div className="space-y-3 pt-4 border-t border-white/5">
                 <Label className="text-[10px] uppercase font-black tracking-widest text-gray-400">Stress Level</Label>
              ...
              <div className="space-y-3 pt-4 border-t border-white/5">
                <Label className="text-[10px] uppercase font-black tracking-widest text-gray-400">Motivation</Label>
          ...
          {step === 2 && (
            <div className="space-y-6 flex-1 pb-4">
              <div className="space-y-3">
                 <Label className="text-[10px] uppercase font-black tracking-widest text-gray-400">Feeling any soreness/pain?</Label>
              ...
              {form.has_soreness && (
                <div className="bg-orange-950/20 border border-orange-500/20 rounded-2xl p-5 space-y-5 shadow-inner backdrop-blur-sm">
                  ...
                  <div className="space-y-4 pt-2 relative z-10">
                     <p className="text-[10px] uppercase font-black tracking-widest text-red-400">Soreness Level</p>
          ...
          {step === 3 && (
            <div className="space-y-6 flex-1 pb-4">
              ...
              <div className="space-y-3 pt-2">
                 <Label className="text-[10px] uppercase font-black tracking-widest text-gray-400">Notes for Coach (Optional)</Label>
                <textarea
          ...
          {step === 4 && (
            <div className="text-center py-6">
              ...
              <h3 className="text-xl font-black text-white uppercase tracking-widest mb-1 drop-shadow-[0_0_5px_rgba(255,255,255,0.3)]">All Set!</h3>
              <p className="text-[10px] uppercase font-bold tracking-widest text-gray-400 mb-6">Your data has been sent to the coach</p>
               ...
               <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-5 flex items-center justify-between text-left shadow-inner border border-white/10 flex-wrap gap-y-3">
                 <div className="w-1/2">
                   <p className="text-[9px] uppercase font-black tracking-widest text-gray-500 mb-1">Sleep</p>
                 ...
                 <div className="w-1/2">
                   <p className="text-[9px] uppercase font-black tracking-widest text-gray-500 mb-1">Energy</p>
                   <p className="font-black text-white tracking-widest text-sm">{form.energy}/5</p>
                 </div>
                 <div className="w-1/2">
                   <p className="text-[9px] uppercase font-black tracking-widest text-gray-500 mb-1">Stress</p>
                   <p className="font-black text-white tracking-widest text-sm">{form.stress}/5</p>
                 </div>
                 {form.has_soreness && (
                    <div className="w-1/2">
                       <p className="text-[9px] uppercase font-black tracking-widest text-orange-400 mb-1">Soreness</p>
